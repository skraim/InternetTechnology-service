 ...
 * 
 */
@WebServiceClient(name = "MyServiceService", targetNamespace = "http://service.nure.ua/", wsdlLocation = "http://localhost:8080/myserv?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICESERVICE_QNAME = new QName("http://service.nure.ua/", "MyServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/myserv?wsdl");
    ...
    public MyService getMyServicePort() {
        return super.getPort(new QName("http://service.nure.ua/", "MyServicePort"), MyService.class);
    }
    ...
    public MyService getMyServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.nure.ua/", "MyServicePort"), MyService.class, features);
    }
